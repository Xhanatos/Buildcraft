// Adapted from Character Options+ Eldritch Heritage (MIT License), copyright
// WittleWolfie and contributors. Reworked for standalone Buildcraft
// ownership, settings, localization, and blueprint IDs.
...
{
  internal static class EldritchHeritageRebalance
  {
    ...
    private static void ConfigureDisabled()
    {
      ...
      FeatureSelectionConfigurator.New(FeatName, Guids.EldritchHeritageFeat)
        ...
        .SetIcon(BlueprintTool.Get<BlueprintFeatureSelection>(BlueprintIds.SorcererBloodlineSelection).Icon)
        .Configure();
      ...
      FeatureSelectionConfigurator.New(GreaterFeatName, Guids.GreaterEldritchHeritageFeat)
        ...
        .AddToAllFeatures(
          AddCapstone(
            ...
            FeatureRefs.BloodlineAbyssalDemonicMight.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureArcaneHeritage15(),
            FeatureRefs.BloodlineArcaneArcaneApotheosisFeature.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureCelestialHeritage15(),
            FeatureRefs.BloodlineCelestialAscensionAbility.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureDraconicBlack15(),
            FeatureRefs.BloodlineDraconicBlackPowerOfWyrms.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureDraconicBlue15(),
            FeatureRefs.BloodlineDraconicBluePowerOfWyrms.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureDraconicBrass15(),
            FeatureRefs.BloodlineDraconicBrassPowerOfWyrms.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureDraconicBronze15(),
            FeatureRefs.BloodlineDraconicBronzePowerOfWyrms.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureDraconicCopper15(),
            FeatureRefs.BloodlineDraconicCopperPowerOfWyrms.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureDraconicGold15(),
            FeatureRefs.BloodlineDraconicGoldPowerOfWyrms.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureDraconicGreen15(),
            FeatureRefs.BloodlineDraconicGreenPowerOfWyrms.Cast<BlueprintFeatureReference>().Reference),
          
          AddCapstone(
            ConfigureDraconicRed15(),
            FeatureRefs.BloodlineDraconicRedPowerOfWyrms.Cast<BlueprintFeatureReference>().Reference),
          
          AddCapstone(
            ConfigureDraconicSilver15(),
            FeatureRefs.BloodlineDraconicSilverPowerOfWyrms.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureDraconicWhite15(),
            FeatureRefs.BloodlineDraconicWhitePowerOfWyrms.Cast<BlueprintFeatureReference>().Reference),
          
          AddCapstone(
            ConfigureElementalAir15(),
            FeatureRefs.BloodlineElementalAirElementalBodyFeature.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureElementalEarth15(),
            FeatureRefs.BloodlineElementalEarthElementalBodyFeature.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureElementalFire15(),
            FeatureRefs.BloodlineElementalFireElementalBodyFeature.Cast<BlueprintFeatureReference>().Reference),

          AddCapstone(
            ConfigureElementalWater15(),
            FeatureRefs.BloodlineElementalWaterElementalBodyFeature.Cast<BlueprintFeatureReference>().Reference),
          
          AddCapstone(
            ConfigureFeyHeritage15(),
            FeatureRefs.BloodlineFeySoulOfTheFeyFeature.Cast<BlueprintFeatureReference>().Reference),
          
          AddCapstone(
            ConfigureInfernalHeritage15(),
            FeatureRefs.BloodlineInfernalPowerOfThePitFeature.Cast<BlueprintFeatureReference>().Reference),
          
          AddCapstone(
            ConfigureSerpentineHeritage15(),
            FeatureRefs.BloodlineSerpentineScaledSoulFeature.Cast<BlueprintFeatureReference>().Reference),
          
          AddCapstone(
            ConfigureUndeadHeritage15(),
            FeatureRefs.BloodlineUndeadOneOfUs.Cast<BlueprintFeatureReference>().Reference))
        .Configure();
    ...
    [TypeId("a872de7a-a550-48f5-9a91-589134a7ff83")]
    ...
    [TypeId("4968b824-8fbf-4d2b-8ace-0f77a2c2a88d")]
    ...
    private static BlueprintFeature AddCapstone(
      BlueprintFeature heritagePower,
      params BlueprintFeatureReference[] capstones)
    {
      if (heritagePower is null)
        throw new InvalidOperationException("Greater Eldritch Heritage power is missing.");

      var levelTwentyFeatures = capstones
        .Where(capstone => capstone is not null)
        .Distinct()
        .Select(capstone => (capstone, level: 20))
        .ToList();
      if (levelTwentyFeatures.Count == 0)
        throw new InvalidOperationException(
          $"Greater Eldritch Heritage power {heritagePower.name} has no bloodline capstone.");

      FeatureConfigurator.For(heritagePower.AssetGuid.ToString())
        .SetReapplyOnLevelUp(true)
        .AddComponent(new AddFeatureOnCharacterLevel(levelTwentyFeatures))
        .Configure();
      return heritagePower;
    }
